...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
      ...
      expect(firstRepositoryItem).toHaveTextContent(fixNumber(1619));
      expect(firstRepositoryItem).toHaveTextContent(fixNumber(21856));
      ...
      expect(secondRepositoryItem).toHaveTextContent(fixNumber(69));
      expect(secondRepositoryItem).toHaveTextContent(fixNumber(1760));
      expect(secondRepositoryItem).toHaveTextContent(fixNumber(72));
      expect(secondRepositoryItem).toHaveTextContent(fixNumber(3));
      });
    });
  });